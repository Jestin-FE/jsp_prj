...
String sha1 = Base64.getEncoder().encodeToString(md2.digest());
String sha256 = Base64.getEncoder().encodeToString(md3.digest());
md3.update(msg2.getBytes());
String sha256_2 = Base64.getEncoder().encodeToString(md3.digest());
%>
MD5 : <%= md5 %><br>
SHA-1 : <%= sha1 %><br>
SHA-256 : <%= sha256 %><br>
...
<%
// sist_util.jar에 제공하는 기능 사용. 위 코드 대체.
