...
// web parameter 받기
// gender=M&lang=Java&lang=C%2FC%2B%2B&lang=PyThon&email=asdf&email=asdf&email=asdf

// <input type= "radio"는 여러개 중 하나만 선택 가능하다. 하나만 parameter로 넘어온다.
...
<li>취미 :
<% 
if (lang != null) { // try문을 사용하면 객체가 더 많이 생성되어 실행되므로 if문이 더 효율적!
// try {
