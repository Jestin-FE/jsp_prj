...
<style type="text/css">
 #container{ min-height: 600px; margin-top: 30px; margin-left: 20px}
	.span {font-weight: : bold; color: #384; font-size: 24px;}
	td {text-align: center; cursor: pointer;}
	td:hover {background-color: #DEE}
</style>
<!-- jquery CDN -->
...
list.add(new DataDTO("img_3.jpg", "이건 못참지", "오전에 수고했고 점심 맛나게 먹엉", "https://www.yogiyo.co.kr/mobile/#/"));
%>
<div>
<% for(DataDTO dto : list) {%>
<div class="card" style="width: 18rem; float: left; margin-right: 10px">
  <img style="width: 300px; height: 160px;" src="http://localhost/jsp_prj/common/images/<%= dto.getImg() %>" class="card-img-top" alt="...">
  <div class="card-body">
    <h5 class="card-title"> <%= dto.getTitle() %></h5>
    <p class="card-text"> <%= dto.getInfo() %></p>
    <a href="#" class="btn btn-primary">가즈아!!</a>
  </div>
</div>
<% } // end for %>
</div>
