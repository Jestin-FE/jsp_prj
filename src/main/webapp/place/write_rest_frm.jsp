...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=97f0db808f9860da7424b7590c32a41a"></script>
<script>
$(function() {
...
$("#btnAdd").click(function(){
	...
	if(confirm("식당 정보를 입력하시려면 로그인 필요. 로그인 하시겠습니까?")) {
...
<form action="rest_frm_process.jsp" method="post"
	name="restFrm" id="restFrm">
