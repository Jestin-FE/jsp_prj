...
int totalCount = 0;
totalCount = ps.totalCount(rDTO); // 게시글 총 수
...
<br>
<a href="write_rest_frm.jsp">당신 등록하기</a>
...
<td><a href="restaurant_detail.jsp?num=${restDTO.rest_num}&currentPage=${rDTO.currentPage}${queryStr}"><c:out value="${restDTO.restaurant}"/></a></td>
