...
<div id="wrap">
  <div id="background">
    ...
    <div id="inputDiv2">
      <form name="subFrm2">
        <span id="showID"><c:out value="${param.id}"></c:out></span>는
        <c:set var="msg" value="사용 가능"></c:set>
        <c:set var="color" value="#00f"></c:set>
        <c:if test="${idFlag}">
        <c:set var="color" value="#f00"></c:set>
        <c:set var="msg" value="사용 불가능"></c:set>    
        </c:if>
        <span style="color:${color}"><c:out value="${msg}"></c:out></span>
