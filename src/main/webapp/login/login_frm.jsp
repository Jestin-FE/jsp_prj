...
<html lang="en" data-bs-theme="auto">
  <head>
  	<c:import url="http://192.168.10.90/jsp_prj/common/jsp/external_file.jsp"/>
    <meta charset="utf-8">
...
<main class="form-signin w-100 m-auto">
  <form name="loginFrm"><!-- AJAX쓸거라서 action필요없다~~ -->
    <h1 class="h3 mb-3 fw-normal">로그인</h1>

    <div class="form-floating">
      <input type="text" value="kim12345" class="form-control" name="id" id="floatingInput" placeholder="아이디">
