...
value="${bDTO.subject}" style="width:520px; border: 1px solid #ccc; height: 30px;"></td>
</tr>
<tr>
<td>내용</td>
<td>
<textarea id="summernote" name="content"><c:out value="${bDTO.content}"></c:out></textarea>
</td>
</tr>
<tr>
<td>조회수</td>
...
<tr>
<td>작성일</td>
<td><strong><fmt:formatDate value="${bDTO.input_date}" pattern="yyyy-MM-dd a HH:mm"/></strong>
</td>
</tr>
<tr>
